...
nonlineardifferential operator.  Not every model
...
thawing. ClimaLSM.jl creates additional sources as necessary to
include e.g. root extraction (not available in stand alone mode).
"""
