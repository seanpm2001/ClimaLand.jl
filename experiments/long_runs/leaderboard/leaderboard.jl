...
The argument `leaderboard_base_path` is the path to save the leaderboards and bias plots and
the argument `diagnostics_folder_path` is the path to the simulation data.
"""
function compute_leaderboard(leaderboard_base_path, diagnostics_folder_path)
    sim_var_dict, obs_var_dict, mask_dict, compare_vars_biases_plot_extrema =
